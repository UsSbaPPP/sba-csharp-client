...
namespace sbaCSharpClient
{
    public class sbaCSharpClientTest
    {
        ...
        public PPP3LoanOriginationController ppp3LoanOriginationController;
        public sbaCSharpClientTest()
        {
            ...
            ppp3LoanOrigination = configurationRoot.GetSection("ppp3-Loan-Origination_URL").Value;
            ...
            ppp3LoanOriginationController =
                new PPP3LoanOriginationController(
                    new PPP3LoanOriginationService(new SbaRestApiClient(BaseUri, ApiToken, VendorKey)));
            #endregion
        }
